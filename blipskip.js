...
function trySkipAd() {
    ...
    if (adSkipButtonContainer && adSkipButtonContainer?.style.display !== 'none') {
...
function hideads() {
    const adContainer = document.querySelectorAll('ytd-ad-slot-renderer');
    
    if (adContainer) {
       adContainer.forEach(function(addiv) { addiv.style.display = 'none';})
    }
}
